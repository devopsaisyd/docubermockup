...
from app.routers import admin, assignments, auth, billing, chat, clinics, doctors, invoices, otp, payments, payouts, push, shifts
...
app.include_router(push.router, prefix="", tags=["devices"])
